package net.lldv.surveysystem.components.language;
...
public class Language {
    ...
    public static void init(SurveySystem surveySystem) {
        messages.clear();
        surveySystem.saveResource("messages.yml");
        Config m = new Config(surveySystem.getDataFolder() + "/messages.yml");
